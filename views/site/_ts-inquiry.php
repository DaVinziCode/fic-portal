...
<dciv class="modal-container">
    ...
    <?php $form = ActiveForm::begin([
        ...
        'action' => ['inquire'], // Adjust the action as needed
    ...
    <div class="panel panel-success">
        ...
        <div style="padding: 10px 20px; margin-top:10px;">
            ...
            <div class="contact-block">
                ...
                <?= Html::hiddenInput('techServiceId', $_GET['techServiceId']); ?>
                ...
                <div class="form-group" style="margin-top: -20px;">
                    ...
                    $form->field($model, 'email')->textInput(['placeholder' => 'Your Email', 'class' => "form-control", 'id' => "email", 'type' => "email"])
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    try {
                        ...
                        notificationArea.html('<div class="alert alert-error">Inquiry submitted successfully. Please check your email for further instructions. Thank you!</div>');
