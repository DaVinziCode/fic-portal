...
$finished = str_replace(",", "", $capitalize);
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                ...
                <div class="btn-group-vertical btn-block">
                    <a class="filter filtered btn btn-common btn-effect" data-filter="all" style="color: #fff; background-color:#0984e3; text-align:left">
                        All
                    </a>
                    <?php foreach (TechService::getServices() as $service) : ?>
                        <a class="filter filtered btn btn-common btn-effect" style="font-size: 12px; color: #fff; background-color:#0984e3" data-filter=.<?= $service->id ?>>
                            <?= $service->name ?>
                        </a>
                    <?php endforeach; ?>
                </div>
                    ...
                    <div class="tab-pane fade show active">
                        <div class="product-items mt-30">
                            <div class="row product-items-active">
                                ...
                                // $endIndex = ceil($totalItems - $itemsPerPage);
                                                                        ...
                                                                        <div class="card_image">
                                                                            ...
                                                                            <div class="product-overlay">
                                                                                <div class="overlay-content center" style="padding-bottom:95px">
                                                                                    ...
                                                                                    <button type="button" id="firstModalButton" data-toggle="modal" data-target="#myTechservice-<?= $tech->id ?>" class="info btn-primary" style="font-size:medium">More Details</button>

                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="card_content">
                                                                            <h2 class="card_title" style="font-size: 17px;"><?php if ($tech->equipment !== null) : ?>
                                                                            ...
                                                                            <div class="card_text">
                                                                                <ul class="nav nav-pills" style="font-size: 15px;">
                                                                                    ...
                                                                                    <p>
                                                                                        <li><span class="pull-left" style="font-size: 18px;"><b>Fee: </b><?= number_format($tech->charging_fee) ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></li>
                                                                                    </p>
                                                                                    <p>
                                                                                ...
                                                                                <div class="col-md-7 portfolio-details" style="padding-top: 30px; padding-bottom: 20px">
                                                                                    <div class="portfolio-info" style="padding-bottom: 10px;">
                                                                                        ...
                                                                                        <ul style="margin-top: -10px; color:#2f3640; font-size: 15px">
                                                                                            ...
                                                                                            <li><span id="inquiry-button-<?= $tech->id ?>">
                                                                                                    <?= Html::a(
                                                                                                        'INQUIRE',
                                                                                                        ...
                                                                                                        [
                                                                                                            ...
                                                                                                            'role' => 'modal-remote',
                                                                                                            'title' => 'Inquire',
                                                                                                            'class' => 'info btn-primary input1-button',
                                                                                                            'type' => 'submit',
                            ...
                            if ($items > 6) : ?>
                                ...
                                <nav aria-label="Page navigation for Services">
                                    <ul id="pagination1" class="pagination1 pagination-left">
                                        <?php if (!$isFirstPage) : ?>
...
<script>
    var categoryButtons = document.querySelectorAll('.filtered');

    // Get the pagination element by its id
    var pagination = document.getElementById('pagination1');

    // Loop through the category buttons
    categoryButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            // Check if the button clicked has a specific data-filter attribute
            if (button.getAttribute('data-filter') !== 'all') {
                // Hide the pagination when a specific category is clicked
                pagination.style.visibility = 'hidden';
            } else {
                // Show the pagination when the "All" category is clicked
...
<style>
    ...
    .pagination1.pagination-category {
        /* Your category-specific styles here */
        display: -ms-flexbox;
        display: flex;
        padding-left: 0;
        list-style: none;
