...
class MunicipalityCity extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Customer::class, ['municipality_city_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Fic::class, ['municipality_city_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Supplier::class, ['municipality_city_id' => 'id']);
    }
}
