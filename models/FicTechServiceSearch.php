...
class FicTechServiceSearch extends FicTechService
{
    ...
    public function rules()
    {
        return [
            ...
            [['charging_type', 'created_at', 'updated_at', 'techService', 'equipment', 'description'], 'safe'],
            [['charging_fee'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'pagination' => [
                'pageSize' => 6, // Change this to your desired limit
            ],
            'sort' => ['defaultOrder' => ['id' => SORT_DESC]],
        ]);

        // ... Rest of your search method code
        ...
        $query->andFilterWhere(['like', 'charging_type', $this->charging_type])
            ->andFilterWhere(['like', '{{%tech_service}}.name', $this->techService])
